...
return [
  ...
  // 42. eBay Sync
  'welcome' => 'Welcome to the eBay sync package. Your marketplace is ready to connect with eBay store. After you authorise, the marketplace will be able to update your eBay store\'s data.',
  ...
  // 76. Shippo
  'shippo' => [
    // 'shippo_test_token' => 'Enter your shippo API testing token',
    // 'shippo_live_token' => 'Enter your shippo API production token',
  ...
  'auction' => [
    ...
    // 'min_price' => 'The bid amount must be equal to or greater than the base price.',
  ...
  'smartForm' => [
    ...
    // 'notify_smart_form_deleted_successfully' => 'Smart Form deleted successfully',
    'notify_smart_form_created_successfully' => 'Smart Form created successfully',
    // 'notify_failed_to_create_smart_form' => 'Failed to create Smart Form',
    'notify_failed_to_update_smart_form' => 'Failed to update Smart Form',
    // 'notify_failed_to_delete_smart_form' => 'Failed to delete Smart Form',
    // 'notify_failed_to_change_smart_form' => 'Failed to change Smart Form',
    // 'notify_smart_form_application_status_updated' => 'Smart Form application status updated',
    // 'notify_smart_form_application_status_not_updated' => 'Smart Form application status not updated',
    ...
    // 'help_file_types' => 'Insert accepted filetypes as comma separated string',
  ...
  'affiliate' => [
    ...
    'you_dont_have_any_links_yet' => 'You dont have any affiliate link yet!',
    'you_dont_have_any_links_with_commission' => 'You dont have any affiliate link with commission yet!',
