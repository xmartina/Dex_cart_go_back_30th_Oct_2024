<div class="row">
  ...
  <div class="{{ \App\Models\SystemConfig::CustomerNeedsApproval() ? 'col-md-3 nopadding-right' : 'col-md-6' }} nopadding-left">
    <div class="form-group">
  ...
  @if(\App\Models\SystemConfig::CustomerNeedsApproval())
    <div class="col-md-3 nopadding-left">
      <div class="form-group">
        {!! Form::label('approval_status', trans('app.form.approval_status') . '*') !!}
        {!! Form::select('approval_status', ['1' => trans('app.statuses.approved'), '0' => trans('app.statuses.declined')], null, ['class' => 'form-control select2-normal', 'placeholder' => trans('app.placeholder.status'), 'required']) !!}
        <div class="help-block with-errors"></div>
      </div>
    </div>
  @endif
