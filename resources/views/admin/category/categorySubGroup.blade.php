    ...
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        @can('create', \App\Models\CategorySubGroup::class)
          <a href="javascript:void(0)" data-link="{{ route('admin.catalog.categorySubGroup.translate.bulk') }}" class="ajax-modal-btn btn btn-default btn-flat"><em class="fa fa-language"></em> {{ trans('app.bulk_translation_import') }}</a>
        ...
        <tbody id="massSelectArea">
          @foreach ($categorySubGrps as $categorySubGrp)
            <tr>
              ...
              <td><a href="{{ route('admin.catalog.categorySubGroup.showParentCategories', $categorySubGrp) }}"><span class="label label-default">{{ $categorySubGrp->categories_count }}</span></a></td>
