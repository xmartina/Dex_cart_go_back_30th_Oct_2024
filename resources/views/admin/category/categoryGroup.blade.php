        ...
        <tbody id="massSelectArea">
          @foreach ($categoryGrps as $categoryGrp)
            <tr>
              ...
              <td>
                <a href="{{ route('admin.catalog.categoryGroup.subGroups', ['categoryGrp' => $categoryGrp->id]) }}"><span class="label label-default">{{ $categoryGrp->sub_groups_count }}</span></a>
              </td>
              ...
              <td class="row-options">
                @can('update', $categoryGrp)
                  ...
                  <a href="{{ route('admin.catalog.categoryGroup.translate.form', ['category_group' => $categoryGrp, 'language' => config('system_settings.default_language')]) }}"><em class="fa fa-language" data-toggle="tooltip" data-placement="top" title="{{ trans('app.manage_translations') }}"></em></a>
                @endcan
