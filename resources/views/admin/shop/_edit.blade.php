    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-md-6 nopadding-right">
          <div class="form-group">
            {!! Form::label('custom_subscription_fee', trans('packages.subscription.custom_subscription_fee'), ['class' => 'with-help']) !!}
            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="{{ trans('packages.subscription.custom_subscription_fee_help_text') }}"></i>
            <div class="input-group">
              ...
              {!! Form::number('custom_subscription_fee', null, ['class' => 'form-control', 'step' => 'any', 'min' => '0', 'placeholder' => trans('packages.subscription.bill_amount'), is_incevio_package_loaded('subscription') ? '' : 'disabled']) !!}
        ...
        <div class="col-md-6 nopadding-left">
          <div class="form-group">
            {!! Form::label('commission_rate', trans('packages.dynamicCommission.custom_commission_rate'), ['class' => 'with-help']) !!}
            <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="{{ trans('packages.dynamicCommission.custom_commission_rate_help_text') }}"></i>
            <div class="input-group">
              {!! Form::number('commission_rate', null, ['class' => 'form-control', 'step' => 'any', 'placeholder' => trans('packages.dynamicCommission.custom_commission_rate'), is_incevio_package_loaded('dynamicCommission') ? '' : 'disabled']) !!}
