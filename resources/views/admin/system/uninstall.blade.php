<div class="modal-dialog modal-sm">
  <div class="modal-content">
    {!! Form::open(['route' => 'admin.setting.system.license.reset', 'class' => 'ajax-form', 'data-toggle' => 'validator']) !!}
    ...
    <div class="modal-body">
      ...
      <p class="text-danger">
        <i class="fa fa-exclamation-triangle"></i> {!! trans('help.uninstall_app_license') !!}
      </p>
    </div>
